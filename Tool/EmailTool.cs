...
namespace Tool
{
    ...
    {
        public static void SendMail(string server, string user, string pwd, string port, string from, string to, string title, string msg)
        {
            EmailTool email = new EmailTool(server, to, from, title, msg, user, pwd, "25", false, false);
            email.Send();
        }

        private static DateTime lastSendTime = DateTime.Now.AddDays(-1);
        public static void SendToQQ(string msg = "有待处理事情..", string priHead = "YZM")
        {
            //smtp.163.com
            string senderServerIp = "smtp.163.com";// "123.125.50.133";
            string toMailAddress = "279241400@qq.com";
            string fromMailAddress = "lkmgydx@163.com";
            string subjectInfo = msg;
            string bodyInfo = "QQHX-" + priHead + " " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            string mailUsername = "lkmgydx@163.com";
            string mailPassword = "123456qq"; //发送邮箱的密码（）
            mailPassword = "UQCQKOQJASMRSAOF";
            string mailPort = "25";
            // string attachPath = null;// "E:\\123123.txt; E:\\haha.pdf";

            //NEW QQ邮箱
            //senderServerIp = "smtp.qq.com";
            //mailPort = "465";
            //fromMailAddress = "827898273@qq.com";
            //mailUsername = "827898273@qq.com";
            //mailPassword = "123456qq";

            EmailTool email = new EmailTool(senderServerIp, toMailAddress, fromMailAddress, subjectInfo, bodyInfo, mailUsername, mailPassword, mailPort, true, false);
        ...
        public EmailTool(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
