namespace HFrameWork.SystemInput
{
    ...
    using static SystemDll.HUser32;

    public sealed class HMouse
    {
        private static string create = (DateTime.Now.ToShortTimeString() + " -> 279241400@qq.com");
        private static int hHook;
        private static HUser32.HookProcDelegate hProc;
        ...
        {
            HUser32.ShowCursor(false);
        }

        public static void ShowMouse()
        {
            HUser32.ShowCursor(true);
        }
        ...
        {
            HUser32.mouse_event(2, 0, 0, 0, 0);
        }

        public static void leftup()
        {
            HUser32.mouse_event(4, 0, 0, 0, 0);
        }
        ...
        {
            HUser32.GetCursorPos(ref point);
            return point;
        }

        public static void middledown()
        {
            HUser32.mouse_event(0x20, 0, 0, 0, 0);
        }

        public static void middletup()
        {
            HUser32.mouse_event(0x40, 0, 0, 0, 0);
        }
        ...
        private static int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
                ...
                switch (wParam)
                {
                    ...
                    case 0x201:
                        ...
                        if (OnMouseDoubleClick != null)
                        {
                            ...
                            timer.Tick += new EventHandler(HMouse.t_Tick);
                        }
                        break;
            ...
            return HUser32.CallNextHookEx(hHook, nCode, wParam, lParam);
        }
        ...
        public static int SetHook()
        {
            if (hHook == 0)
            {
                hProc = new HUser32.HookProcDelegate(HMouse.MouseHookProc);
                hHook = SetWindowsHookEx(14, hProc, IntPtr.Zero, 0);
            }
            return hHook;
        }
        ...
        {
            mouse_event(0x800, 0, 0, -i, 0);
        }

        public static void DrawMousePosition(Point pt)
        {
            System.IntPtr p = (IntPtr)HUser32.GetDC(IntPtr.Zero);// '取得屏幕
